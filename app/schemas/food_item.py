...
class FoodItemSchema(BaseModel):
    ...
    phosphorous: Optional[float] = Field(None, description="Phosphorous in mg.")
    iron: Optional[float] = Field(None, description="Iron in mg.")
    vitamin_a: Optional[float] = Field(None, description="Vitamin A in µg.")
    vitamin_b1: Optional[float] = Field(None, description="Vitamin B1 in mg.")
    vitamin_b2: Optional[float] = Field(None, description="Vitamin B2 in mg.")
    vitamin_b3: Optional[float] = Field(None, description="Vitamin B3 in mg.")
    vitamin_b9: Optional[float] = Field(None, description="Vitamin B9 in mg.")
